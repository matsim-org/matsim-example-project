...
import org.matsim.tutorial.class2017.freefloatbikesharing.setup.SetupBikesharing;
...
public class RunBikesharingExample {
	...
	public static void main(String[] args) {
		...
		new RunBikesharingExample().run(config,otfvis);
	...
	public void run(Config config, boolean otfvis) {
		...
		SetupBikesharing.installBikesharingModules(controler);
		controler.run();
	}
